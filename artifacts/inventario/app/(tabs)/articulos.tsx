...
export default function ArticulosScreen() {
  ...
  async function crear() {
    ...
    if (!nombre) return;
    const nuevo: Articulo = { id: genId(), nombre, foto: fotoUri, creadoEn: fechaHoy() };
  ...
  const listPadBottom = TAB_BAR_HEIGHT + 80;
  const styles = makeStyles(colors, fabBottom, listPadBottom);
...
function makeStyles(
  ...
  return StyleSheet.create({
    ...
    lista: { padding: 16, paddingBottom: listPadBottom },
    vacio: {
      flex: 1,
      alignItems: "center",
